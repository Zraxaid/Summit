    ...
    home: {
      sections: {
        ...
        benefits: {
          ...
          body:
            "Top comps, pre-qualified leads, A-rated carriers, and weekly trainings. Real systems instead of guesswork, with a diversified line-up that keeps producers writing all year.",
          ...
          items: [
            ...
            "A-RATED CARRIERS ACROSS EVERY LIFE PRODUCT",
